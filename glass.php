                    ...
                    <div class="grid_12">
                        <nav>
                            <ul class="menu">
                                ...
                                <li><a class="active" href="glass.php">Glass</a></li>
...
<!-- content -->
    <section id="content">
        <div class="bg-top">
            ...
            <p class="gallery_desc">Тук можем да праснем всякакво и обширно инфо за glass</p>
                <?php
                    if ($handle = opendir('C:\xampp\htdocs\interio\images\fullscreen\glass')) {
                        $i = 0;
                        while (false !== ($entry = readdir($handle))) {
                            if ($entry != "." && $entry != "..") {
                                echo "<li><a href=\"images/fullscreen/glass/";
                                echo "$entry\n";
                                echo "\" rel=\"prettyPhoto[gal2]\"><img src=\"images/fullscreen/glass/";
                                echo "$entry\n";
